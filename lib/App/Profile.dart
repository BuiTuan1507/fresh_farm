    ...
    return new Scaffold(
      ...
      body: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child :Column(
                children: <Widget>[
                  ...
                  Center(
                    child: Text(
                      'Courage',style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.black45),
                    ),
                  ),
                  Center(
                    child: Text(
                      'Email: courageDog@gmail.com',
                      style: TextStyle(fontSize: 20, fontStyle: FontStyle.italic,color: Colors.black45),
                    ),
                  )
                ],
              )
                    ...
                    child: Row(
                      children: <Widget>[
                        Container(
                          padding: EdgeInsets.only(left: 40,right: 15),
                          child:  Icon(
                            Icons.monetization_on, size: 23, color: Colors.green,
                          ),
                        ),
                        Container(
                          padding: EdgeInsets.only(right: 20),
            ...
            Container(
              padding: EdgeInsets.only(top: 30,left: 40,right: 40, bottom: 5),
              height: 75,
