...
import 'Detail.dart';
class MyFastFoodPage extends StatefulWidget{
  _MyFastFoodPageState createState() => new _MyFastFoodPageState(); // ghi de 1 doi tuong trang thai private
}

class _MyFastFoodPageState extends State<MyFastFoodPage>{
