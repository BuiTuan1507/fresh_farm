...
import 'Detail.dart';
class MyTeaPage extends StatefulWidget{
  _MyTeaPageState createState() => new _MyTeaPageState(); // ghi de 1 doi tuong trang thai private
}

class _MyTeaPageState extends State<MyTeaPage>{
