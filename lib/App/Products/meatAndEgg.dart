...
import 'Detail.dart';
class MyMeatPage extends StatefulWidget{
  _MyMeatPageState createState() => new _MyMeatPageState(); // ghi de 1 doi tuong trang thai private
}

class _MyMeatPageState extends State<MyMeatPage>{
