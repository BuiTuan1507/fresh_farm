...
import 'Detail.dart';
class MyVegetablePage extends StatefulWidget{
  _MyVegetablePageState createState() => new _MyVegetablePageState(); // ghi de 1 doi tuong trang thai private
}

class _MyVegetablePageState extends State<MyVegetablePage>{
