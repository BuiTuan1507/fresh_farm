...
import 'Detail.dart';
class MyFlowerPage extends StatefulWidget{
  _MyFlowerPageState createState() => new _MyFlowerPageState(); // ghi de 1 doi tuong trang thai private
}

class _MyFlowerPageState extends State<MyFlowerPage>{
