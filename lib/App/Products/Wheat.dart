...
import 'Detail.dart';
class MyWheatPage extends StatefulWidget{
  _MyWheatPageState createState() => new _MyWheatPageState(); // ghi de 1 doi tuong trang thai private
}

class _MyWheatPageState extends State<MyWheatPage>{
