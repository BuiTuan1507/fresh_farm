...
class Thit extends StatefulWidget{
  String uid;
  String name;
  String photoURL;
  String email;
  Thit({Key key, this.uid,this.name, this.photoURL, this.email}) : super(key: key);
  @override
  _ThitState createState() => _ThitState();
}
class _ThitState extends State<Thit> {
  Widget build(BuildContext context) {
    ...
    Consumer<Cart>(builder: (context, cart, child) {
      ...
      for (int i = 0; i<userList1.length;i++){
        if((userList1[i].id >= 41) && (userList1[i].id <=48)){
