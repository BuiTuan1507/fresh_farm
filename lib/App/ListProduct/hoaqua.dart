...
class Hoaqua extends StatefulWidget {
  String uid;
  String name;
  String photoURL;
  String email;

  Hoaqua({Key key, this.uid, this.name, this.photoURL, this.email})
      : super(key: key);

  @override
  _HoaquaState createState() => _HoaquaState();
}

class _HoaquaState extends State<Hoaqua> {
  Widget build(BuildContext context) {
    ...
    return ((userList1 != null) && (favorite != null))
      ...
      List<Item> userList = [];
      List<int> chiso = [17, 18, 19, 20, 21, 22, 23, 24];
