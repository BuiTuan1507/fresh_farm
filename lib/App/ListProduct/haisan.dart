...
class Haisan extends StatefulWidget{
  String uid;
  String name;
  String photoURL;
  String email;
  Haisan({Key key, this.uid,this.name, this.photoURL, this.email}) : super(key: key);
  @override
  _HaisanState createState() => _HaisanState();
}
class _HaisanState extends State<Haisan> {
  Widget build(BuildContext context) {
    ...
    Consumer<Cart>(builder: (context, cart, child) {
      ...
      for (int i = 0; i<userList1.length;i++){
        if((userList1[i].id > 8)&&(userList1[i].id <=16)){
