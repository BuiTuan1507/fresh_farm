...
class Ngucoc extends StatefulWidget{
  String uid;
  String name;
  String photoURL;
  String email;
  Ngucoc({Key key, this.uid,this.name, this.photoURL, this.email}) : super(key: key);
  @override
  _NgucocState createState() => _NgucocState();
}
class _NgucocState extends State<Ngucoc> {
  Widget build(BuildContext context) {
    ...
    Consumer<Cart>(builder: (context, cart, child) {
      ...
      for (int i = 0; i<userList1.length;i++){
        if((userList1[i].id > 24) && (userList1[i].id) <=32 ){
